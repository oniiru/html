...
<?php //<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.6/jquery-ui.min.js" type="text/javascript"></script> ?>
...
jQuery(document).ready( function(){
			jQuery( '#howdy' ).howdyDo({
				...
				duration	: 500,
				closeAnchor	: '<img src="https://solidwize.com/solidwize/wp-content/uploads/2012/01/close-16x16.png" border=0 />',
						openAnchor	: '<img src="https://solidwize.com/solidwize/wp-content/uploads/2012/01/up.png" border=0 />',
...
<script type="text/javascript">
			function footerPosition () {
				...
				var minheight=jQuery(window).outerHeight()-(footerHeight+jQuery('#header').outerHeight()); 
				
				jQuery('.main-area').css('min-height',minheight-58+'px');
				if (bodyHeight+footerHeight<=jQuery(window).outerHeight()) 
					{
...
if ($ka_logo_text == ''){
?>
<a href="<?php if(is_user_logged_in())  echo home_url().'/member/'; else echo home_url(); ?>" class="logo"><img src="<?php echo $ka_sitelogo; ?>" alt="<?php bloginfo('name'); ?>" /></a>
<?php }else{?>
...
<ul id="menu-main-nav" class="<?php if (is_user_logged_in() ) print 'navlogged'; ?>">
<?php 
if ( !is_user_logged_in() )
wp_nav_menu(array('theme_location' => 'visitors' , 'depth' => 0 , 'container' =>false , 'walker' => new description_walker() )); 
else
wp_nav_menu(array('theme_location' => 'signedin' , 'depth' => 0 , 'container' =>false , 'walker' => new description_walker() )); 
?>
</ul>
<?php endif; ?>
...
?>
<!-- <div id="howdy"> FREE WEBINAR: Rendering with Photoview 360 on September 12th <a class="webinarsbutton" href="http://solidwize.com/webinars">Register Now</a></div> -->
