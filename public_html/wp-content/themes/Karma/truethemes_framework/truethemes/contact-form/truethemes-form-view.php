...
<script type="text/javascript" src="<?php echo TRUETHEMES_PLUGIN_URL; ?>/js/truethemes.js?00004"></script>
<script type="text/javascript">
...
<style>
	...
	.fb-remove { background: url('<?php echo TRUETHEMES_PLUGIN_URL; ?>/images/grunion-remove-field.gif') no-repeat; position: absolute; cursor: pointer !important; right: -26px; top: 27px; width: 20px; height: 23px; }
	.fb-remove:hover { background: url('<?php echo TRUETHEMES_PLUGIN_URL; ?>/images/grunion-remove-field-hover.gif') no-repeat; }
	.fb-remove-small { top: 2px !important; }
	.fb-remove-option { position: absolute; top: 1px; right: 10px; width: 20px; height: 23px; background: url('<?php echo TRUETHEMES_PLUGIN_URL; ?>/images/grunion-remove-option.gif') no-repeat; }
	.fb-remove-option:hover { background: url('<?php echo TRUETHEMES_PLUGIN_URL; ?>/images/grunion-remove-option-hover.gif') no-repeat; }
