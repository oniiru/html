...
function wp_aff_handle_wp_user_registration($user_id) {
	...
	$fields['street'] = $_REQUEST['baddress1'];
	$fields['town'] = $_REQUEST['baddress2'];
	$fields['state'] = $_REQUEST['bstate'];
	$fields['postcode'] = $_REQUEST['bzipcode'];
	$fields['country'] = $_REQUEST['bcountry'];
	$fields['phone'] = $_REQUEST['bphone'];
