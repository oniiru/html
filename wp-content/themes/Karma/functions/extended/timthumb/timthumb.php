...
define ('CACHE_SIZE', 1);	 // number of files to store before clearing cache, originally 1000.
define ('CACHE_CLEAR', 20);					// maximum number of files to delete on each cache clear
define ('CACHE_USE', True);					// use the cache files? (mostly for testing)
define ('CACHE_MAX_AGE', 864000);
...
define ('CURL_TIMEOUT', 50);				// timeout duration. Tweak as you require (lower = better)
