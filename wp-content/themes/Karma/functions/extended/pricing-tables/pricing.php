...
if(uds_pricing_is_plugin()) {
	...
	define('UDS_PRICING_URL', trailingslashit(get_template_directory_uri() . '/functions/extended/pricing-tables'));
	define('UDS_PRICING_PATH', trailingslashit(get_template_directory() . '/functions/extended/pricing-tables'));
}
