...
function siteoptions_add_admin() {
    ...
    $of_page = add_submenu_page('themes.php', 'Site Options', 'Site Options', 'edit_theme_options', 'siteoptions','siteoptions_options_page');
...
function of_style_only() {
	wp_enqueue_style('admin-style', KARMA_FRAMEWORK.'/admin/admin-style.css');
	wp_enqueue_style('color-picker', KARMA_FRAMEWORK.'/admin/css/colorpicker.css');
	$color = get_user_option('admin_color');
	if ($color == "fresh")
		{
		wp_enqueue_style('admin-style-grey', KARMA_FRAMEWORK.'/admin/admin-style-grey.css');
		}
}
...
function of_load_only() {
	...
	wp_register_script('jquery-input-mask', KARMA_FRAMEWORK.'/admin/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('jquery-input-mask');
	wp_enqueue_script('color-picker', KARMA_FRAMEWORK.'/admin/js/colorpicker.js', array('jquery'));
	wp_enqueue_script('ajaxupload', KARMA_FRAMEWORK.'/admin/js/ajaxupload.js', array('jquery'));
