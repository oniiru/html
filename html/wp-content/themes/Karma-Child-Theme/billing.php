...
<div class="main-area" style="padding-top: 0px !important;">	<div class="main-holder">
	...
	global $bfirstname, $blastname, $baddress1, $baddress2, $bcity, $bstate, $bzipcode, $bcountry, $bphone, $bemail,  $CardType, $AccountNumber, $ExpirationMonth, $ExpirationYear;
...
<?php if(pmpro_isLevelRecurring($level)) { ?>
				...
				<tr>
					<td>
						...
						<div>
							...
							<input id="bconfirmemail" name="bconfirmemail" type="hidden" class="input" size="20" value="<?php echo esc_attr($bemail)?>" /> 
	...
	<?php } ?>
<?php } else { ?>
	<p>Your current plan is totally free. There is no need to update your billing info.</p>
<?php } ?>	
