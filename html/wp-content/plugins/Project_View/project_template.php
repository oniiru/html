...
"><a href="<?php the_permalink() ?>">
			...
			<div style=" background-size: cover!important;-webkit-background-size: cover!important;background-image: url('<?php echo $thumbnail; ?>');" class="stepimg">
				...
				<div class="stepinfo">
					<?php if ($mooo == "a") { ?>
					<h3 style="color:rgb(133, 133, 133)" class="lessonnumber2"><?php echo var_dump($terms)?></h3>
					<?php } ?>
					<?php if ($mooo == "b") { ?>
					<h3 style="color:#E08484" class="lessonnumber2"><?php echo var_dump($terms)?></h3>
					<?php } ?>
					<?php if ($mooo == "c") { ?>
					<h3 style="color:#7dbd78" class="lessonnumber2"><?php echo var_dump($terms)?></h3>
					<?php } ?>
