  		 ...
  		 <div style="display:block;overflow:hidden;max-width:900px;margin:auto;margin-bottom:30px">
			...
			foreach ( $terms as $term ) {
				...
				$current_terms = join( ", ", $varlesson );
  				...
  				?>
  			 <div style="width:100%; height:23px;text-align:right;padding-top:2px"><a href="<?php echo get_permalink() ?>"><p><i>Return to <?php the_title()?>. <?php echo var_dump($terms) ?> </i></p></a></div>
